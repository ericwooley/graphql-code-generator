...
export const plugin: PluginFunction<ReactFormikRawPluginConfig, Types.ComplexPluginOutput> = (
...
export const validate: PluginValidateFn<any> = async (
  ...
  if (extname(outputFile) !== '.tsx') {
    throw new Error(`Plugin "typescript-react-formik" requires extension to be ".tsx"`);
  }
};
